...
Сейчас как senior web/product дизайнер веду проекты от гипотез и структуры до продакшена: проектирование, дизайн-система, передача в разработку и развитие по метрикам.`;
